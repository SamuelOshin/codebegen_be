  ...
  "files": {{ "path/to/file.py": "<full code>", ... }}
    ...
    def _parse_generated_output(self, output: str) -> Dict[str, str]:
        ...
        try:
            ...
            # The model sometimes generates strings with literal newlines that need to be escaped
            # This is a simple fix - we could make it more robust
            ...
            # Try to fix the JSON by escaping unescaped newlines in strings
            try:
                # A more robust approach would be needed for production
                # For now, let's try manual extraction
